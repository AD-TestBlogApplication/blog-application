...
module Comments
  RSpec.describe EmoteReactionsController, type: :request do
    ...
    let(:comment) { create :comment, commentable: post_record }
    let(:post_record) { create :post }

    describe 'POST create' do
      subject { post "/comments/#{comment.id}/emote_reactions" }
      ...
      context 'as signed in user' do
        subject { post "/comments/#{comment.id}/emote_reactions", params: params }
        ...
        context 'with valid params' do
          ...
          it 'saves emote reaction to comment' do
            expect { subject }.to change { comment.emote_reactions.count }.by(1)
          end
          ...
          it 'redirects back' do
            post "/comments/#{comment.id}/emote_reactions",
                 params: params,
