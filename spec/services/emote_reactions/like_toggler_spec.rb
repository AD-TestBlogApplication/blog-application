...
module EmoteReactions
  RSpec.describe LikeToggler do
    ...
    describe '#call' do
      ...
      context 'like already exists' do
        ...
        it 'returns deleted emote reaction' do
          ...
          expect(deleted_record).to eq existed_like
        end
      end
      ...
      context 'with existed dislike' do
